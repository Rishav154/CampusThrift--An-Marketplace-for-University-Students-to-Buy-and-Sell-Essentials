...
import { Eye, EyeOff, Mail, Lock, LogIn, ArrowLeft, LoaderCircle } from 'lucide-react';
...
export default function LoginForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Do something after login (like redirect)
        } catch (err) {
            ...
            <div className="max-w-md w-full bg-white p-8 rounded-xl border border-gray-800 shadow-lg">
                ...
                <button className="w-full flex items-center justify-center gap-3 font-semibold border border-gray-600 text-orange-400 py-2 rounded-md hover:bg-white hover:text-black transition-all">
                    <svg className="h-5 w-5" viewBox="0 0 533.5 544.3">
                        <path fill="#EA4335" d="M533.5 278.4c0-18.5-1.5-36.2-4.3-53.4H272v101h147.1c-6.4 34.3-25.5 63.4-54.3 82.9v68h87.9c51.5-47.4 80.8-117.2 80.8-198.5z" />
                        <path fill="#34A853" d="M272 544.3c72.8 0 133.9-24.1 178.6-65.5l-87.9-68c-24.4 16.4-55.4 26-90.7 26-69.8 0-129-47.1-150.2-110.3H33v69.1c44.5 88.1 135.7 148.7 239 148.7z" />
                        <path fill="#4A90E2" d="M121.8 326.5c-10.6-31.3-10.6-65.5 0-96.8V160.6H33c-35 69.8-35 151.2 0 221l88.8-55.1z" />
                        <path fill="#FBBC05" d="M272 107.7c39.6 0 75.1 13.6 103 40.2l77.1-77.1C405.9 24.1 344.8 0 272 0 168.7 0 77.5 60.6 33 148.7l88.8 55.1C143 154.8 202.2 107.7 272 107.7z" />
                    </svg>
