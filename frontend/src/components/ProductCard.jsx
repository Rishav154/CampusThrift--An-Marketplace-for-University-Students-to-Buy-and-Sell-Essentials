    ...
    return (
        <>
            <div className={"relative border w-fit overflow-clip z-1 hover:shadow-md rounded-2xl group"}>
                ...
                <div
                    className={"px-3 grid gap-1 py-2 absolute bg-slate-100 w-full bottom-0 translate-y-[3rem] group-hover:translate-y-0 transform transition-all ease-in-out duration-300 rounded-xl"}>
                    <h2>{name}</h2>
                    <div className={"mb-2"}>
                        <span>Rs.{price}</span>
                    </div>
